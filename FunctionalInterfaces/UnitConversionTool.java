...
interface UnitConverter {
    ...
    static double kilometersToMiles(double kilometers) { return kilometers * 0.621371; }
    static double milesToKilometers(double miles) { return miles / 0.621371; }
    static double metersToFeet(double meters) { return meters * 3.28084; }
    static double feetToMeters(double feet) { return feet / 3.28084; }

    // Weight conversions
    static double kilogramsToPounds(double kilograms) { return kilograms * 2.20462; }
    static double poundsToKilograms(double pounds) { return pounds / 2.20462; }
    static double gramsToOunces(double grams) { return grams * 0.035274; }
    static double ouncesToGrams(double ounces) { return ounces / 0.035274; }

    // Volume conversions
    static double litersToGallons(double liters) { return liters * 0.264172; }
    static double gallonsToLiters(double gallons) { return gallons / 0.264172; }
    static double cubicMetersToCubicFeet(double cubicMeters) { return cubicMeters * 35.3147; }
    static double cubicFeetToCubicMeters(double cubicFeet) { return cubicFeet / 35.3147; }

    // Temperature conversions
    static double celsiusToFahrenheit(double celsius) { return (celsius * 9/5) + 32; }
    static double fahrenheitToCelsius(double fahrenheit) { return (fahrenheit - 32) * 5/9; }

    // Logistics specific conversions
    static double kilogramsToTons(double kilograms) { return kilograms / 1000; }
    static double tonsToKilograms(double tons) { return tons * 1000; }
    static double kilometersToNauticalMiles(double kilometers) { return kilometers * 0.539957; }
    static double nauticalMilesToKilometers(double nauticalMiles) { return nauticalMiles / 0.539957; }
...
public class UnitConversionTool {
    public static void main(String[] args) {
        ...
        double cost = shipment1.calculateShippingCost(0.5, 0.2); 
        System.out.println("Shipping cost for " + shipment1.getTrackingNumber() + ": $" + String.format("%.2f", cost));
